...
def dpo_loss(ref_log_probs, policy_log_probs, mask, beta):
    ...
    # https://github.com/jingyaogong/cookmind/issues/298
...
if __name__ == "__main__":
    # ======================== 命令行参数定义 ========================
    parser = argparse.ArgumentParser(description="CookMind DPO (Direct Preference Optimization)")
    ...
    parser.add_argument("--wandb_project", type=str, default="CookMind-DPO", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"CookMind-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
